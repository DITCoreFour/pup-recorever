...
export class SuperadminHeader implements OnDestroy {
  ...
  // Add other navigation need (User Managemnt, Master Data etc.)
  protected navItems: HeaderNavItem[] = [
    ...
    },
    {
      ...
      iconPath: '/assets/user-management.png'
    },
    {
      label: 'Master Data',
      route: '/superadmin/master-data',
      iconPath: '/assets/master-data.png'
    },
  ];
